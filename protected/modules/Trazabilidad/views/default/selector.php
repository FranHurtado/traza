<h1>Generar informe de Trazabilidad</h1>
<div class="form" style="margin: 0 auto;">
	<form method="post" name="form-selector" action="<?php echo Yii::app()->createUrl("Trazabilidad/default/informe"); ?>">
...
<a href="<?php echo Yii::app()->createURL("Trazabilidad"); ?>" class="backButton">Volver</a>